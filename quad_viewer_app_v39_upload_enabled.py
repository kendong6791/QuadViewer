...
APP_SEMANTIC_VERSION = "0.39.0"
APP_DISPLAY_FILENAME = os.path.basename(__file__) if "__file__" in globals() else "quad_viewer_app_v39_upload_enabled.py"
...
if st.session_state.page == "Dataset":
    ...
    if dataset_source == "Upload JSON files":
        uploaded_files = st.file_uploader(
            ...
            help="Upload up to 100 processed injection JSON files.",
        )
        ...
        if upload_signature != st.session_state.get("uploaded_signature"):
