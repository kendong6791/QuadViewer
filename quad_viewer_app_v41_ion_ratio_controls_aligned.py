...
APP_SEMANTIC_VERSION = "0.41.0"
APP_DISPLAY_FILENAME = os.path.basename(__file__) if "__file__" in globals() else "quad_viewer_app_v42_ion_ratio_controls_aligned.py"
...
if st.session_state.page == "Dataset":
    ...
    if dataset_source == "Upload JSON files":
        uploaded_files = st.file_uploader(
            ...
            help="Upload up to 200 processed injection JSON files.",
        )
